...
Repositorio con libretas para el posdoc en LANIA
...
bb_url = 'htapiagroup/imageproc/blob/master/{}'.format
...
def notebooks():
    ...
    '''
    return glob('libretas/[0-9]*.ipynb')
...
def lesson_name(filename):
    ...
    '''
    [ind.end(0) for ind in re.finditer('Libreta[0-9]+',filename)]
